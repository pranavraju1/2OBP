...
const CounterTwo = () => {
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={()=>dispatch({type: 'incrementTwo', value: 1})}>Increase Counter 2</button>
        <button onClick={()=>dispatch({type: 'decrementTwo', value: 1})}>Decrease Counter 2</button>
      </div>
